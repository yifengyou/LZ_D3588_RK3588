...
export BUILD_TAG="LZ_D3588_OLK-6.6_${set_rootfs}"
...
wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/openeuler_OLK-6.6_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/openeuler_OLK-6.6_kernel/Image-OLK-6.6-kdev
ls -alh Image-OLK-6.6-kdev
md5sum Image-OLK-6.6-kdev

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/openeuler_OLK-6.6_kernel/config-OLK-6.6-kdev
ls -alh config-OLK-6.6-kdev
md5sum config-OLK-6.6-kdev

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/openeuler_OLK-6.6_kernel/System.map-OLK-6.6-kdev
ls -alh System.map-OLK-6.6-kdev
md5sum System.map-OLK-6.6-kdev

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/openeuler_OLK-6.6_kernel/rk3588-lz-d3588.dtb
ls -alh rk3588-lz-d3588.dtb
md5sum rk3588-lz-d3588.dtb

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/openeuler_OLK-6.6_kernel/kos-OLK-6.6.tar.gz
ls -alh kos-OLK-6.6.tar.gz
md5sum kos-OLK-6.6.tar.gz
tar -xf kos-OLK-6.6.tar.gz
du -sh kos

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/openeuler_OLK-6.6_kernel/kernel-devel-OLK-6.6.tar.gz
ls -alh kernel-devel-OLK-6.6.tar.gz
md5sum kernel-devel-OLK-6.6.tar.gz
tar -xf kernel-devel-OLK-6.6.tar.gz
du -sh kernel-devel

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/openeuler_OLK-6.6_kernel/kernel-headers-OLK-6.6.tar.gz
