...
export BUILD_TAG="LZ_D3588_linux-6.1.y-rockchip_${set_rootfs}"
...
wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/Image-linux-6.1.y-rockchip-kdev
ls -alh Image-linux-6.1.y-rockchip-kdev
md5sum Image-linux-6.1.y-rockchip-kdev

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/config-linux-6.1.y-rockchip-kdev
ls -alh config-linux-6.1.y-rockchip-kdev
md5sum config-linux-6.1.y-rockchip-kdev

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/System.map-linux-6.1.y-rockchip-kdev
ls -alh System.map-linux-6.1.y-rockchip-kdev
md5sum System.map-linux-6.1.y-rockchip-kdev

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/rk3588-lz-d3588.dtb
ls -alh rk3588-lz-d3588.dtb
md5sum rk3588-lz-d3588.dtb

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/kos-linux-6.1.y-rockchip.tar.gz
ls -alh kos-linux-6.1.y-rockchip.tar.gz
md5sum kos-linux-6.1.y-rockchip.tar.gz
tar -xf kos-linux-6.1.y-rockchip.tar.gz
du -sh kos

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/kernel-devel-linux-6.1.y-rockchip.tar.gz
...
wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/kernel-headers-linux-6.1.y-rockchip.tar.gz
