...
export BUILD_TAG="LZ_D3588_6.18.y_${set_rootfs}"
...
wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/rockchip-linux_develop-6.1_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/rockchip-linux_develop-6.1_kernel/Image-develop-6.1-kdev
ls -alh Image-develop-6.1-kdev
md5sum Image-develop-6.1-kdev

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/rockchip-linux_develop-6.1_kernel/config-develop-6.1-kdev
ls -alh config-develop-6.1-kdev
md5sum config-develop-6.1-kdev

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/rockchip-linux_develop-6.1_kernel/System.map-develop-6.1-kdev
ls -alh System.map-develop-6.1-kdev
md5sum System.map-develop-6.1-kdev

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/rockchip-linux_develop-6.1_kernel/rk3588-lz-d3588.dtb
ls -alh rk3588-lz-d3588.dtb
md5sum rk3588-lz-d3588.dtb

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/rockchip-linux_develop-6.1_kernel/kos-develop-6.1.tar.gz
ls -alh kos-develop-6.1.tar.gz
md5sum kos-develop-6.1.tar.gz
tar -xf kos-develop-6.1.tar.gz
du -sh kos

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/rockchip-linux_develop-6.1_kernel/kernel-devel-develop-6.1.tar.gz
ls -alh kernel-devel-develop-6.1.tar.gz
md5sum kernel-devel-develop-6.1.tar.gz
tar -xf kernel-devel-develop-6.1.tar.gz
du -sh kernel-devel

wget -c https://github.com/yifengyou/LZ_D3588_RK3588/releases/download/rockchip-linux_develop-6.1_kernel/kernel-headers-develop-6.1.tar.gz
